...
fig3 <-
  ...
  annotation_custom(ggplotGrob(fig3_inset), xmin = 0.3, xmax = 0.55,
                    ymin = 7, ymax = 17)

fig3

# save for publication
ggsave(file = "figures/fig3.pdf", fig3, width = 6, height = 4)
```
...
fig1 <-
  ...
  as.matrix() %>% as.tibble() %>%
  mutate(model = c("Null - Condition",
                   "Null - Familiarity",
                   "Null - Condition+Familiarity",
                   "Null - Condition*Familiarity",
                   "Condition - Familiarity",
                   "Condition - Condition+Familiarity",
                   "Condition - Condition*Familiarity",
                   "Familiarity - Condition+Familiarity",
                   "Familiarity - Condition*Familiarity",
                   "Condition+Familiarity - Condition*Familiarity")) %>%
...
# save for publication
ggsave(file = "figures/fig1.pdf", fig1, height = 4.5, width = 7)
```
...
fig2 <- plot_grid(fig2a, NULL, fig2b, labels = c('a', '', 'b'), nrow = 1, 
                  align = 'h', rel_widths = c(1, 0.1, 1.2))
ggsave(file = "figures/fig2.pdf", fig2, width = 10.1, height = 4.5)
```
