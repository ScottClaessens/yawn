...
ggsave(fig6, file = "figures/fig6.jpg", width = 6, height = 4)
```
...
# save for publication
ggsave(file = "figures/fig5.pdf", fig5, height = 2.5, width = 6)
ggsave(file = "figures/fig5.jpg", fig5, height = 2.5, width = 6)
```
