...
fig6 <-
  ...
  annotation_custom(ggplotGrob(fig6_inset), xmin = 0.35, xmax = 0.6,
                    ymin = 3.5, ymax = 8)

fig6

# save for publication
ggsave(fig6, file = "figures/fig6.pdf", width = 6, height = 4)
```
...
fig5 <-
  ...
  as.matrix() %>% as.tibble() %>%
  mutate(model = c("Null - Prosocial",
                   "Null - Trial",
                   "Null - Prosocial+Trial",
                   "Null - Prosocial*Trial",
                   "Prosocial - Trial",
                   "Prosocial - Prosocial+Trial",
                   "Prosocial - Prosocial*Trial",
                   "Trial - Prosocial+Trial",
                   "Trial - Prosocial*Trial",
                   "Prosocial+Trial - Prosocial*Trial")) %>%
...
# save for publication
ggsave(file = "figures/fig5.pdf", fig5, height = 4.5, width = 7)
```
