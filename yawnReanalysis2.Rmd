...
figS2a <-
  ...
  annotation_custom(ggplotGrob(figS2a_inset), xmin = 0.55, xmax = 0.9,
                    ymin = 3, ymax = 6)
...
```{r echo=F}
# cleanup
rm(fig1a_inset, figS2a_inset, post, cond1, cond2, diff)
```
...
figS4 <-
  ...
  theme(axis.line = element_blank(),
        ...
        axis.title.x = element_text(margin = margin(t = 10)),
        legend.title = element_blank()) +
  annotation_custom2(ggplotGrob(figS4_insetFamiliar), 
                     data=data.frame(Familiarity="Familiar", Condition = NA, yawns = 1),
                     xmin=0.4, xmax=0.95, ymin=3.5, ymax=6.5) +
  annotation_custom2(ggplotGrob(figS4_insetUnfamiliar), 
...
# save
ggsave(file = "figures/figS4.pdf", figS4, height = 3.5, width = 8)
ggsave(file = "figures/figS4.jpg", figS4, height = 5.5, width = 8)
```
...
rm(fig2_first_row, fig2_second_row, fig2a, fig2a_insetFamiliar,
   fig2a_insetUnfamiliar, fig2b, fig2c, figS4_insetFamiliar,
   figS4_insetUnfamiliar, looFig, cond1fam, cond1unfam,
...
ggsave(file = "figures/figS3.pdf", figS3, height = 3, width = 6)
ggsave(file = "figures/figS3.jpg", figS3, height = 3, width = 6)
```
...
# save plot
figS2_first_row  <- plot_grid(figS2a, labels = c("a"))
figS2_second_row <- plot_grid(figS2b, NULL, figS2c, nrow = 1, labels = c("b", "", "c"),
                              align = 'h', rel_widths = c(1, 0.1, 1.2))
figS2 <- plot_grid(figS2_first_row, NULL, figS2_second_row, ncol = 1,
                   align = 'v', rel_heights = c(1, 0.1, 1))
ggsave(file = "figures/figS2.pdf", figS2, width = 7.5, height = 7)
ggsave(file = "figures/figS2.jpg", figS2, width = 7.5, height = 7)
```
...
rm(fig1_first_row, fig1_second_row, fig1a, fig1b, fig1c,
   figS2_first_row, figS2_second_row, figS2a, figS2b, figS2c,
   looFig, post)
```
...
figS5 <-
  ...
  theme(axis.line = element_blank(),
        ...
        axis.title.x = element_text(margin = margin(t = 10)),
        legend.title = element_blank()) +
  annotation_custom2(ggplotGrob(figS5_insetMale), 
                     data=data.frame(Sex="Male", Condition = NA, yawns = 1),
                     xmin=0.45, xmax=0.95, ymin=3.5, ymax=6) +
  annotation_custom2(ggplotGrob(figS5_insetFemale), 
...
# save
ggsave(file = "figures/figS5.pdf", figS5, height = 3.5, width = 8)
ggsave(file = "figures/figS5.jpg", figS5, height = 3.5, width = 8)
```
...
rm(fig3_first_row, fig3_second_row, fig3a, fig3a_insetFemale, fig3a_insetMale,
   fig3b, fig3c, figS5_insetFemale, figS5_insetMale, looFig, post, cond1f, cond1m, 
